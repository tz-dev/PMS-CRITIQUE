...
**PMS–CRITIQUE is a formal application of the [Praxeological Meta-Structure (PMS)](https://github.com/tz-dev/Praxeological-Meta-Structure-Theory)** — a generative operator framework (Δ–Ψ) for modelling praxis, asymmetry, temporality, and self-binding.

While PMS provides the **canonical operator grammar** for analysing action and non-action, PMS–CRITIQUE reconstructs *critique itself* as a **structurally constrained praxis form**: how irritation becomes interruptible, how critique mutates under load, and why correction requires more than expression, judgment, or exposure.
...
* why critique is not an attitude but a **χ-stabilized interruption**,
* how critique mutates into reaction, judgment, narrative reset, silence, or exposure under load,
* how **asymmetry (Ω)** and **temporality (Θ)** redistribute costs even when “nothing happens,”
* why recontextualization (Φ) without integration (Σ) produces analytic drift,
* and why durable critique requires **self-binding (Ψ)** without becoming coercive.
...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18175456.svg)](https://doi.org/10.5281/zenodo.18176263)

---

## What PMS–CRITIQUE Is
...
* A viability model that evaluates critique by:
  ...
  * rather than moral correctness or rhetorical force
...
## What PMS–CRITIQUE Is *Not*

PMS–CRITIQUE is not:

* A theory of “good discourse” or conversational virtue
* A psychological account of motives, traits, or sincerity
...
how to keep critique legible without collapsing into advice or blame.
...
It explains why critique so often fails *even when intentions are good* —
and why interruption, without integration and binding, mutates into drift.
